...
#ifndef APPLICATION_PAARBAND_EXE_PAARBAND_SRC_BMI_160_H_
#define APPLICATION_PAARBAND_EXE_PAARBAND_SRC_BMI_160_H_
...
#include <stdbool.h>
  ...
  */
   ...
   * DEFINES
   */
#define DOUBLE_TAP	0x0004
#define SINGLE_TAP	0x0008
 ...
 * @return  None.
 */
void Bmi160_Gyro_Config(uint8_t Range_reg);
 ...
 * @return  None.
 */
void BMI160_Acc_Config(uint8_t Range_reg);
 ...
 * @return  None.
 */
void BMI160_INT_S_tap(uint8_t tap_th);

/*********************************************************************
 * @fn      BMI160_STEP_COUNT_READ
 *
 * @brief
 *
 * @param   None.
 ...
 * @return  None.
 */
uint32_t BMI160_STEP_COUNT_READ(void);

/*********************************************************************
 * @fn      BMI160_STEP_Config
 *
 * @brief
 *
 * @param   None.
 ...
 * @return  None.
 */
void Imu_readRegs(uint8_t reg, uint8_t* pVal, uint8_t len);
